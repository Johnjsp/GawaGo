...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('jobs', '0002_jobposting_worker_slots'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('hired', 'Hired'), ('rejected', 'Rejected'), ('closed', 'Closed')], default='pending', max_length=20)),
